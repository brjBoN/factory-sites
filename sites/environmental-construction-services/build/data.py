...
PINNED = [
    ...
    {'label': 'CONTROL WATER', 'aria': 'CONTROL WATER — explore drainage services',
     'href': 'services/drainage/', 'asset': 'thumb-control-water.png'},
    {'label': 'CLEAR & PREP', 'aria': 'CLEAR & PREP — explore land clearing, excavation, and site preparation services',
     'href': 'services/land-clearing-excavation/', 'asset': 'thumb-clear-prep.png'},
    {'label': 'BUILD ACCESS', 'aria': 'BUILD ACCESS — explore culvert and driveway services',
